...
export function RelationForm({ entities, universeId, sourceId, onSubmit, onCancel }: RelationFormProps) {
  ...
  return (
    <div className="fixed inset-0 bg-ink/60 dark:bg-white/30 z-50 flex items-end sm:items-center justify-center sm:p-4" onClick={onCancel} role="dialog" aria-modal="true" aria-label={t("relation.title")}>
